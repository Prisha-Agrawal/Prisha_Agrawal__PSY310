...
expName = 'selfpacedreading'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\Prisha AU\\MONSOON 2024\\PSY310 - LAB\\SOLO PROJECT\\selfpacedreading_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Please solve this math problem while the next set of sentences are displayed. \n\n64 divided by 4 \n\nYou do not need to enter any answer. Press the space bar key once you have calculated the answer. ',
        font='Arial',
    ...
    stimuli_2 = visual.TextStim(win=win, name='stimuli_2',
        text='',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.06, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('conditions_sprt.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrial_2 in trials_2:
        ...
        trial2 = data.Routine(
            name='trial2',
            components=[stimuli_2, key_resp_2],
        )
        trial2.status = NOT_STARTED
        continueRoutine = True
        # update component parameters for each repeat
        stimuli_2.setText(S2)
